...
const Login = () => {
  ...
  const handleFormSubmit = async (values: any) => {
    console.log(`[${new Date().toLocaleString()}] [INFO] Login.tsx > handleFormSubmit : values from form submission `, values);
  };
  ...
  return (
    <Wrapper elevation={3} passwordVisibility={passwordVisibility}>
      ...
      <FlexRowCenter mt="1.25rem">
        ...
        <Link href="/bazaar-pro/pages-sections/sessions/Signup" passHref legacyBehavior>
          <a>
