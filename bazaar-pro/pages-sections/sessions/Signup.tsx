...
const Signup: FC = () => {
  ...
  const handleFormSubmit = async (values: any) => {
    console.log(`[${new Date().toLocaleString()}] [INFO] Signup.tsx > handleFormSubmit : values from form submission `, values);
  };
  ...
  return (
    <Wrapper elevation={3} passwordVisibility={passwordVisibility}>
      ...
      <FlexRowCenter mt="1.25rem">
        ...
        <Link href="/bazaar-pro/pages-sections/sessions/Login" passHref legacyBehavior>
          <a>
            <H6 ml={1} borderBottom="1px solid" borderColor="grey.900">
              Login
            </H6>
