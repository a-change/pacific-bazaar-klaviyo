...
//templates
import {HeaderDefault} from '@/components/header/templates/HeaderDefault';

export const HeaderComponent = () => {
  const page = useContext(BrPageContext);
  const component = useContext(BrComponentContext);

  const {headerTemplate: template} = page.getChannelParameters();
  ...
  switch (template) {
    case 'default':
    default:
      return <HeaderDefault {...headerTemplateProps} {...{page, component}} />;
  }
};