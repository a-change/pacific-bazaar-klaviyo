...
export const BannerCollectionTextOverImage: FC<BrProps & BannerCollectionTemplateProps> = (props: BrProps & BannerCollectionTemplateProps) => {
  ...
  return (
    <Grid container spacing={4} sx={{marginY: 1}}>
      {banners.map((banner, key) => {
        return (
          <Grid item md={gridSize} xs={12} key={key}>
            <BannerComponent
              {...{page, component}}
              {...banner}
              disableWrapper
