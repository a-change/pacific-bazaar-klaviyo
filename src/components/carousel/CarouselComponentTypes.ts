...
type CarouselComponentCustomProps = {
  pageable: Partial<Record<string, Reference>>;
  params?: CarouselComponentParams;
};

type CarouselTemplateProps = {
  carouselContent: CarouselContent,
  carouselParams?: CarouselComponentParams
}
...
export type {
  ...
  CarouselTemplate,
  CarouselComponentParams,
  CarouselComponentCustomProps,
};